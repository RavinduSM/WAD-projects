...
<body>
	...
	<div class="container">
	<h2>SIGN UP</h2>
	<form id="form5" name="admin_login" method="post" action="">
		...
		<?php 
		  ...
		  $password=$_POST["txtpassword"];
			$con = mysqli_connect("localhost","root","","grocery");   
			  ...
			  $sql = "select username,password from admin where username='".$aname."' and password='".$password."'";
		...
		<a href="adminregistration.php">Dont have an account</a>
